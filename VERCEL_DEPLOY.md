...
`FOCUS_LIST_PIN` protects the personal cloud Focus List. The PIN is checked only by the Vercel API route; the `focus_tickers` table has no public read/write policy.
