...
function auditAtomicPublicationContract() {
  ...
  assert(workflow.includes("scripts/daily_retry_gate.py") && workflow.includes('cron: "00 03 * * 2-6"') && workflow.includes('cron: "00 04 * * 2-6"'), "failed daily publications must receive one Melbourne-time guarded retry");
