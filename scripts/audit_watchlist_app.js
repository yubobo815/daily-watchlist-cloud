...
function auditAtomicPublicationContract() {
  ...
  assert(workflow.includes("scripts/daily_retry_gate.py") && workflow.includes('cron: "17 03 * * 2-6"') && workflow.includes('cron: "17 04 * * 2-6"') && workflow.includes('cron: "17 06 * * 2-6"') && workflow.includes('cron: "17 07 * * 2-6"'), "failed daily publications must receive Melbourne-time guarded retries away from the top of the hour");
